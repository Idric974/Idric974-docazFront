...
import styles from '../../../../styles/Post/CompoUpdateAnnonce.module.css';
import React, { useEffect, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { timestampParser } from '../Utils';
import { updatePost } from '../../actions/posts.action';
import { getUser } from '../../actions/user.actions';
import { useRouter } from 'next/router';

const CompUpdateAnnonce = ({ children, href }) => {
  //
  ...
  let getPostId = () => {
    ...
    postId = router.asPath.split('/UpdateAnnonce?')[1];
  ...
  return (
    <div className={styles.box}>
      <h1 className={styles.boxTile}>Modifiez votre annonce</h1>
...
export default CompUpdateAnnonce;
